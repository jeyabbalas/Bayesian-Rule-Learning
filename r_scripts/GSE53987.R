...
data.pheno <- as.data.frame(pData(data[[1]])[, c(2,40)])
...
View(data.pheno)
data.pheno$"@Class" <- gsub('.*disorder', 'Case', data.pheno$"@Class")
data.pheno$"@Class" <- gsub('schizophrenia', 'Case', data.pheno$"@Class")
