...
############ Extracting dataset 11: GSE19429 ############
geo_id = 'GSE19429'
...
View(data.pheno)
data.pheno$"@Class" <- gsub('uninvolved skin from cases', 'Normal', data.pheno$"@Class")
data.pheno$"@Class" <- gsub('normal skin from controls', 'Normal', data.pheno$"@Class")
data.pheno$"@Class" <- gsub('involved skin from cases', 'Case', data.pheno$"@Class")
