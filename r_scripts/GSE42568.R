...
data.pheno <- as.data.frame(pData(data[[1]])[, c(2,50)])
...
View(data.pheno)
data.pheno$"@Class" <- gsub('breast cancer', 'Case', data.pheno$"@Class")
data.pheno$"@Class" <- gsub('normal breast', 'Normal', data.pheno$"@Class")
