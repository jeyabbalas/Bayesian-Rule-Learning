...
############ Extracting dataset 11: GSE30999 ############
geo_id = 'GSE30999'
...
View(data.pheno)
data.pheno$"@Class" <- gsub('psoriasis lesion (LS)', 'Case', data.pheno$"@Class")
data.pheno$"@Class" <- gsub('non-lesion (NL)', 'Normal', data.pheno$"@Class")
