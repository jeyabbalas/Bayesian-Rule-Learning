...
data.pheno <- as.data.frame(pData(data[[1]])[, c(2,44)])
...
View(data.pheno)
data.pheno$"@Class" <- gsub('^Tumor.*', 'Case', data.pheno$"@Class")
data.pheno$"@Class" <- gsub('none', 'Normal', data.pheno$"@Class")
