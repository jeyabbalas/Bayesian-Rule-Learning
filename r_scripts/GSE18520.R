...
data.pheno <- as.data.frame(pData(data[[1]])[, c(2,41)])
...
View(data.pheno)
data.pheno$"@Class" <- gsub('^papillary.*', 'Case', data.pheno$"@Class")
data.pheno$"@Class" <- gsub('^ovarian.*', 'Normal', data.pheno$"@Class")
